...
![image-20231103105837551](assets/image-20231103105837551-20250526165337-yo0up15.png)
...
![image-20231103110502057](assets/image-20231103110502057-20250526165337-topylrm.png)
...
![image-20231103110559686](assets/image-20231103110559686-20250526165337-3wbi8rw.png)
...
![image-20231103112157435](assets/image-20231103112157435-20250526165337-l41s37t.png)

**适用场景**​ **:** 在触发频率高的事件中, 执行耗费性能操作 , 连续触发 , 单位时间内只有一次生效

**优化之前:**  每当触发事件就会执行业务逻辑

![image-20231103112319492](assets/image-20231103112319492-20250526165337-ioya2mf.png)

**优化之后:** 触发事件之后延迟执行逻辑,在逻辑执行完毕之后无法再次触发

![image-20231103112334032](assets/image-20231103112334032-20250526165337-eingxho.png)

### 手写节流

使用节流将播放器记录时间的例子优化:

![image-20231103112334032](assets/image-20231103112334032-20250526165337-eingxho.png)![image-20231103112334032](assets/image-20231103112334032-20250526165337-eingxho.png)
