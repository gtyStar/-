...
![image-20230711003405635](assets/image-20230711003405635-20250310200711-idjzzed.png)

## 项目页面介绍

![image-20230706205300370](assets/image-20230706205300370-20250310200711-o0umrin.png)

![image-20230706210947086](assets/image-20230706210947086-20250310200711-nxgkozu.png)

![image-20230706211055251](assets/image-20230706211055251-20250310200711-1nqaf3z.png)

![image-20230706211033589](assets/image-20230706211033589-20250310200711-zfiiwwj.png)
...
![image-20230710172832242](assets/image-20230710172832242-20250310200711-3s694s3.png)

## ESLint & prettier 配置代码风格

ESLint 中文文档：[https://eslint.nodejs.cn/docs/latest/use/configure/configuration-files](https://eslint.nodejs.cn/docs/latest/use/configure/configuration-files)
...
1. prettier 风格配置 [https://prettier.io](https://prettier.io/docs/en/options.html%20)
...
![image-20230710215822678](assets/image-20230710215822678-20250310200711-n4v3sdd.png)
...
![image-20230710225018162](assets/image-20230710225018162-20250310200711-wazp5qx.png)

**彩蛋：**  ​<span data-type="text" style="color: var(--b3-font-color8);">默认 components 下的文件也会被自动注册~</span>
...
![image-20230711071913061](assets/image-20230711071913061-20250310200711-wwic66p.png)
...
2. 新建 `utils/request.js` 封装 axios 模块
   ...
   [http://www.axios-js.com/zh-cn/docs/#axios-create-config](http://www.axios-js.com/zh-cn/docs/#axios-create-config)
...
![image-20230724224754131](assets/image-20230724224754131-20250310200711-tqfdcex.png)
...
官网地址：[https://vueup.github.io/vue-quill/](https://vueup.github.io/vue-quill/)
