...
- 接口文档：[https://apifox.com/apidoc/shared-12ab6b18-adc2-444c-ad11-0e60f5693f66/doc-2221080](https://apifox.com/apidoc/shared-12ab6b18-adc2-444c-ad11-0e60f5693f66/doc-2221080)
...
![image-20230624164519220](assets/image-20230624164519220-20250301182802-nx87m8c.png)

### 2.项目收获

![image-20230616163440573](assets/image-20230616163440573-20250301182802-gy54peq.png)
...
- 手动选择功能
  ...
  ![68294185617](assets/1682941856172-20250301182802-mbsei2l.png)
- 选择vue的版本
...
- 是否使用history模式
  ...
  ![image-20201025150602129](assets/1682941888453-20250301182802-36slzvj.png)
- 选择css预处理

  ![image-20220629175133593](assets/1682941900018-20250301182802-y0lrm1s.png)
- 选择eslint的风格 （eslint 代码规范的检验工具，检验代码是否符合规范）
- 比如：const age = 18;   =>  报错！多加了分号！后面有工具，一保存，全部格式化成最规范的样子

  ![68294191856](assets/1682941918562-20250301182802-xvlqm8e.png)
- 选择校验的时机 （直接回车）

  ![68294193579](assets/1682941935794-20250301182802-fz8gnlp.png)
- 选择配置文件的生成方式 （直接回车）

  ![68294194798](assets/1682941947985-20250301182802-hfcqv8n.png)
- 是否保存预设，下次直接使用？  =>   不保存，输入 N

  ![68294196155](assets/1682941961551-20250301182802-39poflt.png)
...
- 目录效果
  ...
  ![image-20230616184644176](assets/image-20230616184644176-20250301182802-bo89z1q.png)

## 四、vant组件库及Vue周边的其他组件库

组件库：第三方封装好了很多很多的组件，整合到一起就是一个组件库。

[https://vant-ui.github.io/vant/v2/#/zh-CN/](https://vant-ui.github.io/vant/v2/#/zh-CN/)

![image-20230616184726099](assets/image-20230616184726099-20250301182802-yuvkoen.png)
...
![68294468866](assets/1682944688666-20250301182802-dj1qd4l.png)
...
![68294483040](assets/1682944830403-20250301182802-3ct9hx3.png)
...
## 八、<span data-type="text" style="color: var(--b3-font-color8);">项目中的vw适配</span>
...
![image-20230617152947594](assets/image-20230617152947594-20250301182802-zf532pk.png)
...
3. 将准备好的一些图片素材拷贝到 assets 目录【备用】
   ...
   ![image-20230617155648436](assets/image-20230617155648436-20250301182802-4oszzwr.png)

### (2) 登录静态布局

![image-20230617160232955](assets/image-20230617160232955-20250301182802-74ao9gx.png)
...
## 十三、<span data-type="text" style="color: var(--b3-font-color8);">request模块 - axios封装</span>

接口文档：[https://apifox.com/apidoc/shared-12ab6b18-adc2-444c-ad11-0e60f5693f66/doc-2221080](https://apifox.com/apidoc/shared-12ab6b18-adc2-444c-ad11-0e60f5693f66/doc-2221080)

演示地址：[http://cba.itlike.com/public/mweb/#/](http://cba.itlike.com/public/mweb/#/)

基地址：[http://cba.itlike.com/public/index.php?s=/api/](http://cba.itlike.com/public/index.php?s=/api/)
...
![image-20230617161654856](assets/image-20230617161654856-20250301182802-v8qiudw.png)

## 十四、图形验证码功能完成

![image-20230617163721858](assets/image-20230617163721858-20250301182802-5o2jesk.png)
...
![image-20230619121937770](assets/image-20230619121937770-20250301182802-g2rwsbs.png)
...
![image-20230619122706439](assets/image-20230619122706439-20250301182802-7e16st2.png)
...
![image-20230617165906943](assets/image-20230617165906943-20250301182802-nzg2muo.png)
...
## 十九、<span data-type="text" style="color: var(--b3-font-color8);">响应拦截器统一处理错误提示</span>
...
## 二十三、登录访问拦截 - <span data-type="text" style="color: var(--b3-font-color8);">路由前置守卫</span>
...
![image-20230623173049799](assets/image-20230623173049799-20250301182802-44gt61u.png)
...
![image-20230623173117931](assets/image-20230623173117931-20250301182802-y8pzy8d.png)
...
![image-20230620220932154](assets/image-20230620220932154-20250301182802-598wwl6.png)
...
![image-20230621144449700](assets/image-20230621144449700-20250301182802-tcsa8ab.png)
...
![image-20230624222814532](assets/image-20230624222814532-20250301182802-p2ohcjj.png)
...
![image-20230621155728973](assets/image-20230621155728973-20250301182802-h7gonx7.png)
...
![image-20230624231331980](assets/image-20230624231331980-20250301182802-okn9kqp.png)
...
![image-20230624233945821](assets/image-20230624233945821-20250301182802-78meuko.png)
...
![image-20230621193957697](assets/image-20230621193957697-20250301182802-nwjq1vr.png)
...
![image-20230621195126291](assets/image-20230621195126291-20250301182802-dzc08nt.png)
...
![image-20230624150118755](assets/image-20230624150118755-20250301182802-1cc5wf1.png)
...
![image-20230624154814818](assets/image-20230624154814818-20250301182802-9fxwqrp.png)
...
![image-20230624154339504](assets/image-20230624154339504-20250301182802-mxifyp4.png)
...
![image-20230624160427732](assets/image-20230624160427732-20250301182802-51r2dh0.png)
...
![image-20230624161704931](assets/image-20230624161704931-20250301182802-b0awh3p.png)
...
![image-20230702155433790](assets/image-20230702155433790-20250301182802-hh2fjmi.png)
...
// 获取个人信息
export const getUserInfoDetail = () => {a
...
### (2) 在 vue.config.js 配置publicPath
